...
\textit{by}\\[0.02cm]
\textbf{Name of Student}\\[0.01cm]
\textbf{Roll No.}\\[0.03cm]
\textbf{Name of Student}\\[0.01cm]
\textbf{Roll No.}\\[0.03cm]
...
\begin{figure}[hb!]
 \centering
 \includegraphics[scale=0.75]{Pictures/kgce_logo.png}
 % kgce_logo.png: 614x618 px, 300dpi, 5.20x5.23 cm, bb=0 0 147 148
\end{figure}
%\DEPTNAME\\ % Research group name and department name
\textbf{\textsc{DEPARTMENT OF INFORMATION TECHNOLOGY \\[0.01cm]
KONKAN GYANPEETH COLLEGE OF ENGINEERING KARJAT-410201}}\\[0.01cm]
%\small{(Run operate and Managed By Kapil Patil Institute)}\\[0.01cm]
% University name
\small{\textbf{2025-26}}
\end{center}
...
%\acknowledgements
%This page is used as dedication page. contnts to be created by group.  
...
\fancyfoot[CO]{\thepage} % Right footer on Odd pages
